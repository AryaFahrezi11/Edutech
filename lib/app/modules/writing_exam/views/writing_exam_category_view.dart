...
class WritingExamCategoryView extends StatelessWidget {
  const WritingExamCategoryView({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    final categories = [
      _ExamCategoryData(
        ...
        gradient: [const Color(0xFFFF9F1C), const Color(0xFFFFD166)],
        available: true,
        categoryKey: 'capital',
      ),
      _ExamCategoryData(
      ...
      _ExamCategoryData(
        ...
        gradient: [const Color(0xFFFF416C), const Color(0xFFFF9F1C)],
        available: true,
        categoryKey: 'word',
      ),
      _ExamCategoryData(
...
class _ExamCategoryCardState extends State<_ExamCategoryCard>
  ...
  void _handleTap() {
    ...
    // Navigasi ke halaman ujian dengan membawa info kategori
    Get.toNamed(
      Routes.WRITING_EXAM,
      arguments: {'category': widget.data.categoryKey, 'title': widget.data.title},
    );
  }
    ...
    return GestureDetector(
      ...
      child: AnimatedBuilder(
        ...
        child: Container(
          ...
          child: Stack(
            children: [
              // ── Dekorasi lingkaran besar semi-transparan di pojok ──
              if (d.available)
                Positioned(
                  top: -20,
                  right: -20,
                    ...
                    Container(
                      ...
                      child: Center(
                        child: Text(
                          ...
                          style: TextStyle(
                              fontSize: 28,
                              color: d.available ? null : const Color(0xFFB0B0C0)),
                        ),
                      ),
                    ),
                    Column(
                ...
                Positioned(
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      border: Border.all(
                          color: const Color(0xFF9090A0).withOpacity(0.25)),
                    ),
                    child: const Text(
                      'Coming Soon',
                      style: TextStyle(
              ...
              if (!d.available)
                Positioned(
                  ...
                  child: Icon(Icons.lock_rounded,
                      size: 16, color: const Color(0xFF9090A0).withOpacity(0.4)),
                ),
              // ── Chip "Mulai" untuk yang tersedia ──
              if (d.available)
                Positioned(
                  bottom: 12,
                  right: 12,
